(function($) {
	var setupTriangle = {};
	$.fn.setupTriangle = function(opt) {
		var res = _setupTheValues(this);
		setupTriangle[res[1]] = res[0];
		return this;
	};
	...
	$.fn.whichTriangle = function(evt) {
		...
		var res =  _whichTriangleIsPointIn(setupTriangle[index], [evt.clientX, evt.clientY]);
		return res;
	};

	$.fn.updateTriangle = function(opt) {
		this.setupTriangle();
	};
